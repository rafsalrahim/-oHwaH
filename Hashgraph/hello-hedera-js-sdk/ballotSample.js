...
const {
    ...
    ContractFunctionParams, ContractCallQuery, ContractExecuteTransaction} = require("@hashgraph/sdk");
...
async function main() {
    ...
    const smartContract = require("./ballot.json");
    ...
    const getRecord = await (await new ContractExecuteTransaction()
        .setContractId(newContractId)
        .setGas(10000) // ~6016
        .setFunction("giveRightToVote", new ContractFunctionParams()
            .addString("abc"))
        .execute(hederaClient))
