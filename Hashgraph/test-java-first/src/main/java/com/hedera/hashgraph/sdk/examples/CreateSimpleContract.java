...
public final class CreateSimpleContract {
    ...
    private static final AccountId OPERATOR_ID = AccountId.fromString("0.0.48556");
        //AccountId.fromString(Objects.requireNonNull(Dotenv.load().get("OPERATOR_ID")));
    private static final Ed25519PrivateKey OPERATOR_KEY = Ed25519PrivateKey.fromString("302e020100300506032b657004220420ce756561b4c6829ae6c5ef32aac169089efa36faddf43749c113ddbd296c9608");
    ...
    public static void main(String[] args) throws HederaStatusException, IOException {
        ...
        try (InputStream jsonStream = cl.getResourceAsStream("owner.json")) {
            if (jsonStream == null) {
                throw new RuntimeException("failed to get owner.json");
            }
